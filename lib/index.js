...
const portfinder = require('portfinder'); portfinder.basePort = 9229
...
module.exports = function (cmd, options) {
  ...
  const devtools = new Devtools(Object.assign({}, devtoolsOptions, options.devtoolsOptions || {}))
...
const inspectProcess = function (cmd, options, devtools) {
  ...
  return portfinder.getPortPromise().then(port => 
    ...
    const proc = spawn('node', args, options.childOptions)
